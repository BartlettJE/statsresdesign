...
- Can we be confident in the direction of the coefficient? <div class='webex-radiogroup' id='radio_YDFDACOSIY'><label><input type="radio" autocomplete="off" name="radio_YDFDACOSIY" value="x"></input> <span>Yes, the 95% HDI excludes 0</span></label><label><input type="radio" autocomplete="off" name="radio_YDFDACOSIY" value="answer"></input> <span>No, the 95% HDI crosses 0</span></label></div>

- What would your conclusion be for the research question? <div class='webex-radiogroup' id='radio_IPXNBLSWAO'><label><input type="radio" autocomplete="off" name="radio_IPXNBLSWAO" value="x"></input> <span>Recalling unethical behaviour lead people to perceive a room as darker.</span></label><label><input type="radio" autocomplete="off" name="radio_IPXNBLSWAO" value="answer"></input> <span>The effect was in the opposite direction but we would not be confident that the manipulation had an effect.</span></label></div>


- Are the results sensitive to the choice between default and user priors? <div class='webex-radiogroup' id='radio_ZKHCXFOSCI'><label><input type="radio" autocomplete="off" name="radio_ZKHCXFOSCI" value="answer"></input> <span>No, there is little difference in the parameters and our conclusions do not change.</span></label><label><input type="radio" autocomplete="off" name="radio_ZKHCXFOSCI" value="x"></input> <span>Yes, there is a qualitative difference in our conclusions and the parameters change substantially.</span></label></div>

- Does the normal model capture the features of the data? <div class='webex-radiogroup' id='radio_XINYNOPIJQ'><label><input type="radio" autocomplete="off" name="radio_XINYNOPIJQ" value="answer"></input> <span>No, assuming a normal distribution misses key features of the data.</span></label><label><input type="radio" autocomplete="off" name="radio_XINYNOPIJQ" value="x"></input> <span>Yes, assuming a normal distribution captures key features of the data.</span></label></div>
...
|:----------------------|:---------|:-------------------|:-----|:----|:----|:-----|:--|:--|:-------|
|                       |b         |                    |      |     |     |      |   |   |default |
|                       |b         |intervention1       |      |     |     |      |   |   |default |
|                       |b         |time1               |      |     |     |      |   |   |default |
|                       |b         |time1:intervention1 |      |     |     |      |   |   |default |
...
##  time0 effect  -0.0458   -0.1926    0.0926
##  time1 effect   0.0458   -0.0926    0.1926
## 
## intervention = 1:
##  contrast     estimate lower.HPD upper.HPD
##  time0 effect  -0.0893   -0.1948    0.0143
##  time1 effect   0.0893   -0.0143    0.1948
## 
## Point estimate displayed: median 
## HPD interval probability: 0.95
```
...
|:-------------------------|-----------:|---------------:|-------------:|-------------:|
|Model with interaction    |        0.80|            0.05|          0.67|          0.88|
|Model without interaction |        0.81|            0.05|          0.69|          0.88|
...
|:--------------|:---------------------|---------------:|-------------:|-------------:|
|User priors    |b_Intercept           |            3.69|          3.28|          4.09|
|Default priors |b_Intercept           |            3.68|          3.27|          4.08|
|User priors    |b_intervention1       |           -0.08|         -0.59|          0.44|
|Default priors |b_intervention1       |           -0.07|         -0.58|          0.46|
|User priors    |b_time1               |            0.09|         -0.19|          0.38|
|Default priors |b_time1               |            0.09|         -0.19|          0.39|
|User priors    |b_time1:intervention1 |            0.09|         -0.28|          0.43|
|Default priors |b_time1:intervention1 |            0.09|         -0.29|          0.44|
...
- Can we be confident in the direction of the individual predictors? <div class='webex-radiogroup' id='radio_OFMQFUPYOV'><label><input type="radio" autocomplete="off" name="radio_OFMQFUPYOV" value="x"></input> <span>No, the 95% HDI of both coefficients contain 0.</span></label><label><input type="radio" autocomplete="off" name="radio_OFMQFUPYOV" value="x"></input> <span>The 95% HDI of absorption contains 0, but theory of mind is positive and excludes 0.</span></label><label><input type="radio" autocomplete="off" name="radio_OFMQFUPYOV" value="x"></input> <span>The 95% HDI of theory of mind contains 0, but absorption is positive and excludes 0.</span></label><label><input type="radio" autocomplete="off" name="radio_OFMQFUPYOV" value="answer"></input> <span>Yes, both individual predictors are positive and their 95% HDI excludes 0.</span></label></div>

- How can you interpret the interaction? <div class='webex-radiogroup' id='radio_SNUQOJWGJJ'><label><input type="radio" autocomplete="off" name="radio_SNUQOJWGJJ" value="x"></input> <span>There is no clear interaction.</span></label><label><input type="radio" autocomplete="off" name="radio_SNUQOJWGJJ" value="answer"></input> <span>For lower values of theory of mind, the slope becomes more positive.</span></label><label><input type="radio" autocomplete="off" name="radio_SNUQOJWGJJ" value="x"></input> <span>For lower values of theory of mind, the slope becomes more negative.</span></label></div>
...
- Comparing the models with and without the interaction term, which would you retain? <div class='webex-radiogroup' id='radio_NFTZWSTZZK'><label><input type="radio" autocomplete="off" name="radio_NFTZWSTZZK" value="x"></input> <span>The model with the interaction term clearly has the better fit.</span></label><label><input type="radio" autocomplete="off" name="radio_NFTZWSTZZK" value="x"></input> <span>The model without the interaction term clearly has the better fit.</span></label><label><input type="radio" autocomplete="off" name="radio_NFTZWSTZZK" value="answer"></input> <span>There is little difference between the two models, but we would retain the interaction for theoretical interest.</span></label></div>

- Are the results sensitive to the choice between default and user priors? <div class='webex-radiogroup' id='radio_PPRZPOMNYL'><label><input type="radio" autocomplete="off" name="radio_PPRZPOMNYL" value="x"></input> <span>Yes, there is a qualitative difference in our conclusions and the parameters change substantially.</span></label><label><input type="radio" autocomplete="off" name="radio_PPRZPOMNYL" value="answer"></input> <span>No, there is almost no difference in the parameters and our conclusions do not change.</span></label></div>
