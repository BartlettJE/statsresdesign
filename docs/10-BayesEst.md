...
- Can we be confident in the direction of the coefficient? <div class='webex-radiogroup' id='radio_PTQOPQLTJE'><label><input type="radio" autocomplete="off" name="radio_PTQOPQLTJE" value="x"></input> <span>Yes, the 95% HDI excludes 0</span></label><label><input type="radio" autocomplete="off" name="radio_PTQOPQLTJE" value="answer"></input> <span>No, the 95% HDI crosses 0</span></label></div>

- What would your conclusion be for the research question? <div class='webex-radiogroup' id='radio_BRYIWBXACJ'><label><input type="radio" autocomplete="off" name="radio_BRYIWBXACJ" value="x"></input> <span>Recalling unethical behaviour lead people to perceive a room as darker.</span></label><label><input type="radio" autocomplete="off" name="radio_BRYIWBXACJ" value="answer"></input> <span>The effect was in the opposite direction but we would not be confident that the manipulation had an effect.</span></label></div>


- Are the results sensitive to the choice between default and user priors? <div class='webex-radiogroup' id='radio_VQPLPLGPPP'><label><input type="radio" autocomplete="off" name="radio_VQPLPLGPPP" value="answer"></input> <span>No, there is little difference in the parameters and our conclusions do not change.</span></label><label><input type="radio" autocomplete="off" name="radio_VQPLPLGPPP" value="x"></input> <span>Yes, there is a qualitative difference in our conclusions and the parameters change substantially.</span></label></div>

- Does the normal model capture the features of the data? <div class='webex-radiogroup' id='radio_WFZWIDCVBH'><label><input type="radio" autocomplete="off" name="radio_WFZWIDCVBH" value="answer"></input> <span>No, assuming a normal distribution misses key features of the data.</span></label><label><input type="radio" autocomplete="off" name="radio_WFZWIDCVBH" value="x"></input> <span>Yes, assuming a normal distribution captures key features of the data.</span></label></div>
...
- Can we be confident in the direction of the individual predictors? <div class='webex-radiogroup' id='radio_PDOZGVYAQL'><label><input type="radio" autocomplete="off" name="radio_PDOZGVYAQL" value="x"></input> <span>No, the 95% HDI of both coefficients contain 0.</span></label><label><input type="radio" autocomplete="off" name="radio_PDOZGVYAQL" value="x"></input> <span>The 95% HDI of absorption contains 0, but theory of mind is positive and excludes 0.</span></label><label><input type="radio" autocomplete="off" name="radio_PDOZGVYAQL" value="x"></input> <span>The 95% HDI of theory of mind contains 0, but absorption is positive and excludes 0.</span></label><label><input type="radio" autocomplete="off" name="radio_PDOZGVYAQL" value="answer"></input> <span>Yes, both individual predictors are positive and their 95% HDI excludes 0.</span></label></div>

- How can you interpret the interaction? <div class='webex-radiogroup' id='radio_TEKCKKPNUY'><label><input type="radio" autocomplete="off" name="radio_TEKCKKPNUY" value="x"></input> <span>There is no clear interaction.</span></label><label><input type="radio" autocomplete="off" name="radio_TEKCKKPNUY" value="answer"></input> <span>For lower values of theory of mind, the slope becomes more positive.</span></label><label><input type="radio" autocomplete="off" name="radio_TEKCKKPNUY" value="x"></input> <span>For lower values of theory of mind, the slope becomes more negative.</span></label></div>
...
- Comparing the models with and without the interaction term, which would you retain? <div class='webex-radiogroup' id='radio_LDLKANAZVN'><label><input type="radio" autocomplete="off" name="radio_LDLKANAZVN" value="x"></input> <span>The model with the interaction term clearly has the better fit.</span></label><label><input type="radio" autocomplete="off" name="radio_LDLKANAZVN" value="x"></input> <span>The model without the interaction term clearly has the better fit.</span></label><label><input type="radio" autocomplete="off" name="radio_LDLKANAZVN" value="answer"></input> <span>There is little difference between the two models, but we would retain the interaction for theoretical interest.</span></label></div>

- Are the results sensitive to the choice between default and user priors? <div class='webex-radiogroup' id='radio_OXTUOSJVTX'><label><input type="radio" autocomplete="off" name="radio_OXTUOSJVTX" value="x"></input> <span>Yes, there is a qualitative difference in our conclusions and the parameters change substantially.</span></label><label><input type="radio" autocomplete="off" name="radio_OXTUOSJVTX" value="answer"></input> <span>No, there is almost no difference in the parameters and our conclusions do not change.</span></label></div>
