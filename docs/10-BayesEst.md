...
- Can we be confident in the direction of the coefficient? <div class='webex-radiogroup' id='radio_ZDCIROQLAE'><label><input type="radio" autocomplete="off" name="radio_ZDCIROQLAE" value="x"></input> <span>Yes, the 95% HDI excludes 0</span></label><label><input type="radio" autocomplete="off" name="radio_ZDCIROQLAE" value="answer"></input> <span>No, the 95% HDI crosses 0</span></label></div>

- What would your conclusion be for the research question? <div class='webex-radiogroup' id='radio_TALMFPWMBJ'><label><input type="radio" autocomplete="off" name="radio_TALMFPWMBJ" value="x"></input> <span>Recalling unethical behaviour lead people to perceive a room as darker.</span></label><label><input type="radio" autocomplete="off" name="radio_TALMFPWMBJ" value="answer"></input> <span>The effect was in the opposite direction but we would not be confident that the manipulation had an effect.</span></label></div>


- Are the results sensitive to the choice between default and user priors? <div class='webex-radiogroup' id='radio_AXPWTSIDOR'><label><input type="radio" autocomplete="off" name="radio_AXPWTSIDOR" value="answer"></input> <span>No, there is little difference in the parameters and our conclusions do not change.</span></label><label><input type="radio" autocomplete="off" name="radio_AXPWTSIDOR" value="x"></input> <span>Yes, there is a qualitative difference in our conclusions and the parameters change substantially.</span></label></div>

- Does the normal model capture the features of the data? <div class='webex-radiogroup' id='radio_ZARLPNEMUH'><label><input type="radio" autocomplete="off" name="radio_ZARLPNEMUH" value="answer"></input> <span>No, assuming a normal distribution misses key features of the data.</span></label><label><input type="radio" autocomplete="off" name="radio_ZARLPNEMUH" value="x"></input> <span>Yes, assuming a normal distribution captures key features of the data.</span></label></div>
...
- Comparing the models with and without the interaction term, which would you retain? <div class='webex-radiogroup' id='radio_BUIXCCAWQH'><label><input type="radio" autocomplete="off" name="radio_BUIXCCAWQH" value="x"></input> <span>The model with the interaction term clearly has the better fit.</span></label><label><input type="radio" autocomplete="off" name="radio_BUIXCCAWQH" value="x"></input> <span>The model without the interaction term clearly has the better fit.</span></label><label><input type="radio" autocomplete="off" name="radio_BUIXCCAWQH" value="answer"></input> <span>There is little difference between the two models, but we would retain the interaction for theoretical interest.</span></label></div>

- Are the results sensitive to the choice between default and user priors? <div class='webex-radiogroup' id='radio_FFRSERZLVT'><label><input type="radio" autocomplete="off" name="radio_FFRSERZLVT" value="x"></input> <span>Yes, there is a qualitative difference in our conclusions and the parameters change substantially.</span></label><label><input type="radio" autocomplete="off" name="radio_FFRSERZLVT" value="answer"></input> <span>No, there is almost no difference in the parameters and our conclusions do not change.</span></label></div>
