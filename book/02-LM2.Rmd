...
- Rounding to two decimals, the slope for `Country_deviation` is `r fitb(answer = 1.31, num = TRUE, tol = .001)`, suggesting depressive symptoms were higher in `r mcq(opts = c(answer = "the UK", x = "Malaysia"))`. 
