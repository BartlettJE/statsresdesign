...
priors <- c(prior(student_t(3, 4, 3), class = Intercept))
...
priors %>% 
  ...
  guides(fill = "none") +
  labs(x = "Value", y = "Density", title = "student_t(3, 4, 3), class = Intercept") +
  theme_classic()
...
priors %>% 
  ...
  scale_fill_viridis_d(option = "plasma", end = 0.9) +
  guides(fill = "none") +
  labs(x = "Value", y = "Density", title = "student_t(3, 0, 3), class = Intercept") +
  theme_classic()
